#  Examen Ayudantes 2026
## Completar con sus datos
Apellido y Nombre: 
Carrera: 
DNI: 

## Importante Leer antes de comenzar (términos y condiciones)
...
- DEBE realizar un commit cada 15 min o menos.
- DEBE entregar el enunciado del parcial al finalizar el mismo
- DEBE Completar los campos del archivo readme.md con sus datos
- DEBE Generar un archivo .gitignore que excluya los archivos innecesarios de la entrega final
